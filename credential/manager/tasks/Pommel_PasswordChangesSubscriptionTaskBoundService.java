...
public abstract class Pommel_PasswordChangesSubscriptionTaskBoundService extends GmsTaskBoundService implements cyvn, cyyi {
    ...
    public final void onCreate() {
        if (!this.c) {
            this.c = true;
            ((ayzv) h()).g((PasswordChangesSubscriptionTaskBoundService) this);
        }
        super.onCreate();
    }
}
