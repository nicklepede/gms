...
public abstract class Pommel_PasswordChangesSubscriptionTaskBoundService extends GmsTaskBoundService implements cwlq, cwol {
    ...
    public final void onCreate() {
        if (!this.c) {
            this.c = true;
            ((awvv) h()).g((PasswordChangesSubscriptionTaskBoundService) this);
        }
        super.onCreate();
    }
}
