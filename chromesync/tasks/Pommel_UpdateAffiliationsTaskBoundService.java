...
public abstract class Pommel_UpdateAffiliationsTaskBoundService extends GmsTaskBoundService implements cwlq, cwol {
    ...
    public final void onCreate() {
        if (!this.c) {
            this.c = true;
            ((apqy) h()).i((UpdateAffiliationsTaskBoundService) this);
        }
        super.onCreate();
    }
}
