...
public abstract class Pommel_UpdateAffiliationsTaskBoundService extends GmsTaskBoundService implements cyvn, cyyi {
    ...
    public final void onCreate() {
        if (!this.c) {
            this.c = true;
            ((artp) h()).i((UpdateAffiliationsTaskBoundService) this);
        }
        super.onCreate();
    }
}
