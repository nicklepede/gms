...
public abstract class Pommel_SendDeviceInfoTaskBoundService extends GmsTaskBoundService implements cyvn, cyyi {
    ...
    public final void onCreate() {
        if (!this.c) {
            this.c = true;
            ((artm) h()).f((SendDeviceInfoTaskBoundService) this);
        }
        super.onCreate();
    }
}
