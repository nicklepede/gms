...
public final class as extends otm implements au {
    ...
    public final IBinder newAdPreloader(azht azhtVar, com.google.android.gms.ads.internal.mediation.client.e eVar, int i) {
        Parcel fr = fr();
        oto.g(fr, azhtVar);
        oto.g(fr, eVar);
        fr.writeInt(i);
