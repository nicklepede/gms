...
public final class c extends otn implements d {
    ...
    private static void i(String str) {
        if (!str.equals("com.google.android.gms") && !fjzz.a.a().p().b.contains(str)) {
    ...
    public final Bundle a() {
        ...
        aqup.d(context).f(Binder.getCallingUid());
    ...
    public final String d(int i) {
        aqup.d(this.b).f(Binder.getCallingUid());
        return this.a.f(i);
    }
