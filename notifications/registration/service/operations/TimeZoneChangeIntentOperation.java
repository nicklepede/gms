...
public final class TimeZoneChangeIntentOperation extends csee {
    @Override // com.google.android.chimera.IntentOperation
    public final void onHandleIntent(Intent intent) {
        if (new feda(fqob.b().c, fqnv.a).contains(fcuj.TIMEZONE_CHANGED)) {
            ...
            csdt.a(applicationContext, "RE_REGISTER_TIMEZONE_CHANGE");
        }
    }
}
