...
public final class TimeZoneChangeIntentOperation extends cunj {
    @Override // com.google.android.chimera.IntentOperation
    public final void onHandleIntent(Intent intent) {
        if (new fgrt(fthx.b().c, fthr.a).contains(ffja.TIMEZONE_CHANGED)) {
            ...
            cumy.a(applicationContext, "RE_REGISTER_TIMEZONE_CHANGE");
        }
    }
}
