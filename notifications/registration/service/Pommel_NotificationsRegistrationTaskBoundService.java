...
public abstract class Pommel_NotificationsRegistrationTaskBoundService extends GmsTaskBoundService implements cwlq, cwol {
    ...
    public final void onCreate() {
        if (!this.c) {
            this.c = true;
            ((csdv) h()).b((NotificationsRegistrationTaskBoundService) this);
        }
        super.onCreate();
    }
}
