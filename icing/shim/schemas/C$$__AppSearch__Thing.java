...
public final class C$$__AppSearch__Thing implements adp {
    @Override // defpackage.adp
    public final ado a() {
        adc adcVar = new adc("Thing");
    ...
    public final /* bridge */ /* synthetic */ adu b(Object obj) {
        ...
        adt adtVar = new adt(thing.q, thing.p, "Thing");
        adtVar.b("name", thing.r);
        List b = thing.b();
        if (b != null) {
        ...
        adtVar.a("g3attrinfo", adu.e(thing.s));
        return adtVar.e();
    }
    ...
    public final /* bridge */ /* synthetic */ Object c(adu aduVar, adr adrVar) {
        ...
        return new Thing(l, k, str, asList, asList2, f != null ? (G3AttributionInfo) f.j(G3AttributionInfo.class, adrVar) : null);
    }
