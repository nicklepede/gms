...
public final class C$$__AppSearch__DigitalDocument implements adp {
    @Override // defpackage.adp
    public final ado a() {
        adc adcVar = new adc("DigitalDocument");
    ...
    public final /* bridge */ /* synthetic */ adu b(Object obj) {
        ...
        adt adtVar = new adt(digitalDocument.q, digitalDocument.p, "DigitalDocument");
        adtVar.b("name", digitalDocument.r);
        ...
        adtVar.a("g3attrinfo", adu.e(digitalDocument.s));
        Conversation conversation = digitalDocument.a;
        if (conversation != null) {
            adtVar.a("isPartOf", adu.e(conversation));
        }
        adtVar.b("text", digitalDocument.b);
        Person person = digitalDocument.c;
        if (person != null) {
            adtVar.a("author", adu.e(person));
        }
        adtVar.b("annotationId", digitalDocument.d);
        adtVar.b("messageId", digitalDocument.e);
        adtVar.b("conversationId", digitalDocument.f);
        return adtVar.e();
    }
