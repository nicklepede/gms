...
public class DeviceStateSnapshotLoggingTask extends GmsTaskBoundService {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:166:0x0554, code lost:
        ...
        if (r9.getPackageManager().getPackageInfo("com.google.android.apps.photos", r26).versionCode < 222407) goto L234;
     */
    ...
    /* JADX WARN: Removed duplicated region for block: B:201:0x0718 A[ORIG_RETURN, RETURN] */
