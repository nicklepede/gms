...
public abstract class Pommel_PhotosOptInNotificationSenderTask extends GmsTaskBoundService implements cyvn, cyyi {
    ...
    public final void onCreate() {
        if (!this.c) {
            this.c = true;
            ((aluf) h()).b((PhotosOptInNotificationSenderTask) this);
        }
        super.onCreate();
    }
}
