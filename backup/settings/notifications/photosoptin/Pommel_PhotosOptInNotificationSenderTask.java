...
public abstract class Pommel_PhotosOptInNotificationSenderTask extends GmsTaskBoundService implements cwlq, cwol {
    ...
    public final void onCreate() {
        if (!this.c) {
            this.c = true;
            ((ajtm) h()).b((PhotosOptInNotificationSenderTask) this);
        }
        super.onCreate();
    }
}
