...
public class PlaceExitEvent extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new dbqj();
    public final int a;
    ...
    public final String toString() {
        ...
        return "PlaceExitEvent{hierarchyLevel=" + this.a + ", probability=" + this.b + ", topCandidate=" + String.valueOf(this.d) + ", additionalPlaceCandidates=" + String.valueOf(additionalPlaceCandidates) + "}";
    }
