...
public class ActivityStartEvent extends AbstractSafeParcelable {
    ...
    public final String toString() {
        ...
        return "ActivityStartEvent{probability=" + this.a + ", topCandidate=" + String.valueOf(this.c) + ", additionalActivityCandidates=" + String.valueOf(additionalActivityCandidates) + "}";
    }
