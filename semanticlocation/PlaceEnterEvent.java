...
public class PlaceEnterEvent extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new dbqi();
    public final int a;
    ...
    public final String toString() {
        ...
        return "PlaceEnterEvent{hierarchyLevel=" + this.a + ", probability=" + this.b + ", topCandidate=" + String.valueOf(this.d) + ", additionalPlaceCandidates=" + String.valueOf(additionalPlaceCandidates) + "}";
    }
