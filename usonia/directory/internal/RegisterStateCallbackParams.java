...
public final class RegisterStateCallbackParams extends AbstractSafeParcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof RegisterStateCallbackParams) {
            ...
            if (atyq.b(this.a, registerStateCallbackParams.a) && atyq.b(this.b, registerStateCallbackParams.b) && atyq.b(this.c, registerStateCallbackParams.c)) {
                return true;
            }
        }
        return false;
