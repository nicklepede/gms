...
public final class UnregisterStateCallbackParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new dhxm();
    public dhwm a;
    public String b;
    public dhwg c;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof UnregisterStateCallbackParams) {
            ...
            if (arwb.b(this.a, unregisterStateCallbackParams.a) && arwb.b(this.b, unregisterStateCallbackParams.b) && arwb.b(this.c, unregisterStateCallbackParams.c)) {
                return true;
            }
        }
        return false;
