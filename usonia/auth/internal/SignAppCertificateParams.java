...
public final class SignAppCertificateParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new dhvi();
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof SignAppCertificateParams) {
            ...
            if (arwb.b(this.a, signAppCertificateParams.a) && arwb.b(this.b, signAppCertificateParams.b) && Arrays.equals(this.c, signAppCertificateParams.c)) {
                return true;
            }
        }
        return false;
