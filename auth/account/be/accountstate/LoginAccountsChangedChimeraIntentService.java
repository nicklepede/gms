...
public class LoginAccountsChangedChimeraIntentService extends TracingIntentService {
    private static final asot a = asot.c("Auth", asej.AUTH_ACCOUNT_DATA, "LoginAccountsChangedChimeraIntentService");
    private Context b;
    private uux c;
    private uzy d;
    ...
    private static final Set b(Set set) {
        bsa bsaVar = new bsa(set.size());
        Iterator it = set.iterator();
        while (it.hasNext()) {
            bsaVar.add(((url) it.next()).a);
        }
        return bsaVar;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:238:0x0598, code lost:
        ...
        ((defpackage.ejhf) ((defpackage.ejhf) com.google.android.gms.auth.account.be.accountstate.LoginAccountsChangedChimeraIntentService.a.j()).s(r0)).x("Error occurred getting AccountsChange");
     */
    ...
    */
    ...
    public final void onCreate() {
        super.onCreate();
        this.b = this;
        this.c = new uux(this.b);
        this.d = new uzy(this.b);
    }

    LoginAccountsChangedChimeraIntentService(Context context, uzy uzyVar) {
        super("LoginAccountsChangedIntentService");
        this.b = context;
        this.c = new uux(this.b);
        this.d = uzyVar;
