...
public final class VerifiableCredentialDatabase_Impl extends VerifiableCredentialDatabase {
    private volatile aapz m;

    @Override // defpackage.mhx
    protected final mgw a() {
        return new mgw(this, new HashMap(0), new HashMap(0), "VerifiableCredentialEntity");
    }
    ...
    protected final Map e() {
        ...
        hashMap.put(aapz.class, Collections.EMPTY_LIST);
        return hashMap;
    }
