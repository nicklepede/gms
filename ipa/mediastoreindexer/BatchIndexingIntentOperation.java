...
public class BatchIndexingIntentOperation extends IntentOperation {
    ...
    public final void onHandleIntent(Intent intent) {
        ((ejhf) a.h()).x("Starting mediastore batch index");
        bonp bonpVar = new bonp();
        boqq boqqVar = new boqq(5);
        enss d = new bopc(new bopo(getApplicationContext(), bonpVar, boqqVar)).a.d();
        boqr boqrVar = new boqr(d, boqqVar);
        Executor executor = bopo.b;
        ensj.t(d, boqrVar, executor);
        ensj.q(d, fpgv.a.a().q(), TimeUnit.SECONDS, bopo.a);
