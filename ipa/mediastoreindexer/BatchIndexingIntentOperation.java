...
public class BatchIndexingIntentOperation extends IntentOperation {
    ...
    public final void onHandleIntent(Intent intent) {
        ((eluo) a.h()).x("Starting mediastore batch index");
        bqvf bqvfVar = new bqvf();
        bqyg bqygVar = new bqyg(5);
        eqgl d = new bqws(new bqxe(getApplicationContext(), bqvfVar, bqygVar)).a.d();
        bqyh bqyhVar = new bqyh(d, bqygVar);
        Executor executor = bqxe.b;
        eqgc.t(d, bqyhVar, executor);
        eqgc.q(d, fsah.a.lK().q(), TimeUnit.SECONDS, bqxe.a);
