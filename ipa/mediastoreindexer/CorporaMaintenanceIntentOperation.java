...
public class CorporaMaintenanceIntentOperation extends IntentOperation {
    ...
    public final void onHandleIntent(Intent intent) {
        ((eluo) a.h()).x("Starting mediastore corpora maintenance");
        bqvf bqvfVar = new bqvf();
        bqyg bqygVar = new bqyg(6);
        eqgl d = new bqwt(new bqxe(getApplicationContext(), bqvfVar, bqygVar)).a.d();
        bqyh bqyhVar = new bqyh(d, bqygVar);
        Executor executor = bqxe.b;
        eqgc.t(d, bqyhVar, executor);
        eqgc.q(d, fsah.a.lK().u(), TimeUnit.SECONDS, bqxe.a);
