...
public class CorporaMaintenanceIntentOperation extends IntentOperation {
    ...
    public final void onHandleIntent(Intent intent) {
        ((ejhf) a.h()).x("Starting mediastore corpora maintenance");
        bonp bonpVar = new bonp();
        boqq boqqVar = new boqq(6);
        enss d = new bopd(new bopo(getApplicationContext(), bonpVar, boqqVar)).a.d();
        boqr boqrVar = new boqr(d, boqqVar);
        Executor executor = bopo.b;
        ensj.t(d, boqrVar, executor);
        ensj.q(d, fpgv.a.a().u(), TimeUnit.SECONDS, bopo.a);
