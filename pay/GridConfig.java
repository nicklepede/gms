...
public final class GridConfig extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cvlz();
    public int a;
    public boolean b;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof GridConfig) {
            ...
            if (atyq.b(Integer.valueOf(this.a), Integer.valueOf(gridConfig.a)) && atyq.b(Boolean.valueOf(this.b), Boolean.valueOf(gridConfig.b))) {
                return true;
            }
        }
        return false;
