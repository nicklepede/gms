...
public final class WearPrepaidCardDetailIntentArgs extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new ctfi();
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof WearPrepaidCardDetailIntentArgs) {
            ...
            if (arwb.b(this.a, wearPrepaidCardDetailIntentArgs.a) && arwb.b(Integer.valueOf(this.b), Integer.valueOf(wearPrepaidCardDetailIntentArgs.b))) {
                return true;
            }
        }
        return false;
