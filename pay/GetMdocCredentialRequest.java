...
public final class GetMdocCredentialRequest extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new ctcg();
    public String a;
    public byte[] b;
    public byte[] c;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof GetMdocCredentialRequest) {
            ...
            if (arwb.b(this.a, getMdocCredentialRequest.a) && Arrays.equals(this.b, getMdocCredentialRequest.b) && Arrays.equals(this.c, getMdocCredentialRequest.c)) {
                return true;
            }
        }
        return false;
