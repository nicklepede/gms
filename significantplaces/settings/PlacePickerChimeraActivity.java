...
public final class PlacePickerChimeraActivity extends rxx implements ceis {
    public ceio j;
    public dest k;
    public aca l;
    public deue m;
    ...
    public PlacePickerChimeraActivity() {
        deup deupVar = new deup(this);
        int i = fxya.a;
        this.q = new jxm(new fxxg(devi.class), new deuq(this), deupVar, new deur(this));
        this.t = fuvk.b();
    }
    ...
    private final void l() {
        ...
        final fxwo fxwoVar = new fxwo() { // from class: deum
            @Override // defpackage.fxwo
            public final Object a(Object obj) {
                Location location = (Location) obj;
                if (location != null) {
                    ceio ceioVar = PlacePickerChimeraActivity.this.j;
                    if (ceioVar == null) {
                        fxxm.j("map");
                        ceioVar = null;
                    }
        ...
        dhlwVar.z(new dhlq() { // from class: deun
    ...
    public final void a(ceio ceioVar) {
        ...
        ceioVar3.l(new ceil() { // from class: deuf
            ...
            public final void a(int i) {
                ...
                if (editText.hasFocus()) {
                    ...
                    deue deueVar2 = placePickerChimeraActivity.m;
                    if (deueVar2 == null) {
                        fxxm.j("placePickerFragment");
                        deueVar2 = null;
                    }
                    deueVar2.x();
                    deue deueVar3 = placePickerChimeraActivity.m;
                    if (deueVar3 == null) {
                        fxxm.j("placePickerFragment");
                    } else {
                        deueVar = deueVar3;
        ...
        ceioVar2.k(new ceik() { // from class: deug
            @Override // defpackage.ceik
            public final void a() {
                PlacePickerChimeraActivity.this.k(true);
            }
        });
    }
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        this.p = cbqjVar.c();
        this.k = new dest();
        this.l = registerForActivityResult(new acq(), new aby() { // from class: deuh
            ...
            public final void jF(Object obj) {
                ...
                if (activityResult.a == -1) {
                    ...
                    int i3 = dete.a;
                    dete.b(placePickerChimeraActivity);
                }
            }
        });
        findViewById(R.id.button_use_this_place).setOnClickListener(new View.OnClickListener() { // from class: deui
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PlacePickerChimeraActivity placePickerChimeraActivity = PlacePickerChimeraActivity.this;
                ceio ceioVar = placePickerChimeraActivity.j;
                if (ceioVar == null) {
                    fxxm.j("map");
                    ceioVar = null;
                }
                double d = ceioVar.d().a.a;
                ceio ceioVar2 = placePickerChimeraActivity.j;
                if (ceioVar2 == null) {
                    fxxm.j("map");
                    ceioVar2 = null;
                }
                ...
                fgri Q = v.Q();
                fxxm.e(Q, "build(...)");
                fycr.b(jvd.a(placePickerChimeraActivity), null, null, new deuo(placePickerChimeraActivity, (fjym) Q, null), 3);
            }
        });
        ...
        cbreVar.k(102);
        cbriVar.b(cbreVar.a());
        atadVar.ae(cbriVar.a()).x(new dhlk() { // from class: deuj
            ...
            public final void hH(dhlw dhlwVar) {
                ...
                if (atasVar != null) {
                    atasVar.c(PlacePickerChimeraActivity.this.getContainerActivity(), 1387388555);
                }
            }
        });
        this.n = (EditText) findViewById(R.id.edit_text_enter_address);
        ((devi) this.q.a()).a.g(this, new deus(new fxwo() { // from class: deuk
            @Override // defpackage.fxwo
            public final Object a(Object obj) {
                PlacePickerChimeraActivity placePickerChimeraActivity = PlacePickerChimeraActivity.this;
                dexp dexpVar = (dexp) obj;
                deue deueVar = placePickerChimeraActivity.m;
                ceio ceioVar = null;
                if (deueVar == null) {
                    fxxm.j("placePickerFragment");
                    deueVar = null;
        ...
        editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: deul
            @Override // android.view.View.OnFocusChangeListener
            public final void onFocusChange(View view, boolean z) {
                if (z) {
                    deue deueVar2 = PlacePickerChimeraActivity.this.m;
                    if (deueVar2 == null) {
                        fxxm.j("placePickerFragment");
                        deueVar2 = null;
                    }
