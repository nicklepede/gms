...
public class MediaQueueData extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new amcf();
    public String a;
    public String b;
    public int c;
    public String d;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        List list = this.g;
        arxc.y(parcel, 8, list == null ? null : DesugarCollections.unmodifiableList(list), false);
