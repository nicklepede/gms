...
final class OpenSSLECGroupContext {
    ...
    static OpenSSLECGroupContext getInstance(ECParameterSpec eCParameterSpec) {
        ...
        if (!(field instanceof ECFieldFp)) {
            throw new InvalidParameterException("unhandled field class ".concat(String.valueOf(field.getClass().getName())));
        }
    ...
    public ECParameterSpec getECParameterSpec() {
        NativeRef.EC_GROUP ec_group = this.groupCtx;
        String EC_GROUP_get_curve_name = NativeCrypto.EC_GROUP_get_curve_name(ec_group);
