...
public final class OpenSSLECKeyFactory extends KeyFactorySpi {
    ...
    protected PrivateKey engineGeneratePrivate(KeySpec keySpec) {
        ...
        throw new InvalidKeySpecException("Must use ECPrivateKeySpec or PKCS8EncodedKeySpec; was ".concat(String.valueOf(keySpec.getClass().getName())));
    }
    ...
    protected PublicKey engineGeneratePublic(KeySpec keySpec) {
        ...
        throw new InvalidKeySpecException("Must use ECPublicKeySpec or X509EncodedKeySpec; was ".concat(String.valueOf(keySpec.getClass().getName())));
    }
    ...
    protected Key engineTranslateKey(Key key) {
        ...
        if (!(key instanceof PublicKey) || !"X.509".equals(key.getFormat())) {
            throw new InvalidKeyException("Key must be EC public or private key; was ".concat(String.valueOf(key.getClass().getName())));
        }
        byte[] encoded2 = key.getEncoded();
        if (encoded2 == null) {
            throw new InvalidKeyException("Key does not support encoding");
