...
abstract class AbstractConscryptSocket extends SSLSocket {
    ...
    public AbstractConscryptSocket() {
        this.peerInfoProvider = new PeerInfoProvider() { // from class: com.google.android.gms.org.conscrypt.AbstractConscryptSocket.1
    ...
    final void notifyHandshakeCompletedListeners() {
        ...
        for (int i = 0; i < size; i++) {
            try {
                ((HandshakeCompletedListener) arrayList.get(i)).handshakeCompleted(handshakeCompletedEvent);
