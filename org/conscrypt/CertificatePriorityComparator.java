...
public final class CertificatePriorityComparator implements Comparator {
    ...
    private int compareSignatureAlgorithm(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        Map map = ALGORITHM_OID_PRIORITY_MAP;
        Integer num = (Integer) map.get(x509Certificate.getSigAlgOID());
        Integer num2 = (Integer) map.get(x509Certificate2.getSigAlgOID());
        if (num == null) {
    ...
    private int getKeySize(PublicKey publicKey) {
        ...
        throw new IllegalArgumentException("Unsupported public key type: ".concat(String.valueOf(publicKey.getClass().getName())));
    }
