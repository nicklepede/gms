...
final class EvpMdRef {
    ...
    static int getDigestSizeBytesByJcaDigestAlgorithmStandardName(String str) {
        ...
        throw new NoSuchAlgorithmException("Unsupported algorithm: ".concat(String.valueOf(str)));
    }

    static long getEVP_MDByJcaDigestAlgorithmStandardName(String str) {
        String upperCase = str.toUpperCase(Locale.US);
        if ("SHA-256".equals(upperCase)) {
