...
class ConscryptEngineSocket extends OpenSSLSocketImpl implements SSLParametersImpl.AliasChooser {
            ...
            try {
                ...
                if (i != 1) {
                    if (i == 2) {
                        ...
                        if (i != 4 && i != 5) {
                            throw new IllegalStateException("Unknown handshake status: " + String.valueOf(this.engine.getHandshakeStatus()));
                        }
                        z = true;
                    }
    ...
    private static ConscryptEngine newEngine(SSLParametersImpl sSLParametersImpl, ConscryptEngineSocket conscryptEngineSocket) {
        ...
        conscryptEngine.setHandshakeListener(new HandshakeListener() { // from class: com.google.android.gms.org.conscrypt.ConscryptEngineSocket.1
            @Override // com.google.android.gms.org.conscrypt.HandshakeListener
    ...
    public final void close() {
        ...
        int transitionTo = transitionTo(8);
        try {
            if (transitionTo != 8) {
                try {
    ...
    final class SSLOutputStream extends OutputStream {
        ...
        public void writeInternal(ByteBuffer byteBuffer) {
            ...
            do {
                ...
                if (wrap.getStatus() != SSLEngineResult.Status.OK && wrap.getStatus() != SSLEngineResult.Status.CLOSED) {
                    throw new SSLException("Unexpected engine result ".concat(String.valueOf(String.valueOf(wrap.getStatus()))));
                }
        ...
        private void writeToSocket() {
            ...
            this.socketOutputStream.write(byteBuffer.array(), this.targetArrayOffset, byteBuffer.limit());
        }
    ...
    final class SSLInputStream extends InputStream implements InputStreamRetargetInterface {
        ...
        public int processDataFromSocket(byte[] bArr, int i, int i2) {
            ...
            while (this.fromEngine.remaining() <= 0) {
                ...
                ConscryptEngineSocket conscryptEngineSocket = ConscryptEngineSocket.this;
                SSLEngineResult unwrap = conscryptEngineSocket.engine.unwrap(this.fromSocket, this.fromEngine);
                ...
                if (i3 != 1) {
                    if (i3 != 2) {
                        ...
                        throw new SSLException("Unexpected engine result ".concat(String.valueOf(String.valueOf(unwrap.getStatus()))));
                    }
        ...
        public int read() {
            ...
            synchronized (this.readLock) {
                ...
                if (read != 1) {
                    throw new SSLException(a.j(read, "read incorrect number of bytes "));
                }
