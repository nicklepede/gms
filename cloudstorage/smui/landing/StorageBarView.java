package com.google.android.gms.cloudstorage.smui.landing;
...
public final class StorageBarView extends View {
    ...
    protected final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            asos asosVar = (asos) elgoVar.get(i);
            float f6 = i == 0 ? f4 : f5;
            float f7 = asosVar.b * f3;
            ...
            if (i == 0) {
                ...
                f = min;
                canvas.drawLine(f6, f4, f, f4, asosVar.a);
            }
