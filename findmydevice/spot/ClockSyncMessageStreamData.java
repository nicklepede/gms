...
public final class ClockSyncMessageStreamData extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new bcux();
    public int a;
    public byte[] b;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ClockSyncMessageStreamData) {
            ...
            if (arwb.b(Integer.valueOf(this.a), Integer.valueOf(clockSyncMessageStreamData.a)) && Arrays.equals(this.b, clockSyncMessageStreamData.b)) {
                return true;
            }
        }
        return false;
