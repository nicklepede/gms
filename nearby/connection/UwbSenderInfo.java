...
public final class UwbSenderInfo extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cfgd();
    public byte[] a;
    public int b;
    public int c;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof UwbSenderInfo) {
            ...
            if (Arrays.equals(this.a, uwbSenderInfo.a) && arwb.b(Integer.valueOf(this.b), Integer.valueOf(uwbSenderInfo.b)) && arwb.b(Integer.valueOf(this.c), Integer.valueOf(uwbSenderInfo.c))) {
                return true;
            }
        }
        return false;
