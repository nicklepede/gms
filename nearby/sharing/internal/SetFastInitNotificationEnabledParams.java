...
public final class SetFastInitNotificationEnabledParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cnbt();
    public arbp a;
    public boolean b;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof SetFastInitNotificationEnabledParams) {
            ...
            if (arwb.b(this.a, setFastInitNotificationEnabledParams.a) && arwb.b(Boolean.valueOf(this.b), Boolean.valueOf(setFastInitNotificationEnabledParams.b))) {
                return true;
            }
        }
        return false;
