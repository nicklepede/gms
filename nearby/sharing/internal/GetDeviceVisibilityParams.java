...
public final class GetDeviceVisibilityParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cpdu();
    public cpeq a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof GetDeviceVisibilityParams) {
            return atyq.b(this.a, ((GetDeviceVisibilityParams) obj).a);
        }
        return false;
    }
    ...
    public GetDeviceVisibilityParams(IBinder iBinder) {
        ...
        if (iBinder == null) {
            ...
            cpeoVar = queryLocalInterface instanceof cpeq ? (cpeq) queryLocalInterface : new cpeo(iBinder);
        }
        this.a = cpeoVar;
    }
}
