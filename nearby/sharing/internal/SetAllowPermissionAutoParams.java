...
public final class SetAllowPermissionAutoParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cnbn();
    public boolean a;
    public arbp b;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof SetAllowPermissionAutoParams) {
            ...
            if (arwb.b(Boolean.valueOf(this.a), Boolean.valueOf(setAllowPermissionAutoParams.a)) && arwb.b(this.b, setAllowPermissionAutoParams.b)) {
                return true;
            }
        }
        return false;
