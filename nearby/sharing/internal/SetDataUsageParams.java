...
public final class SetDataUsageParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cpjw();
    public int a;
    public atee b;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof SetDataUsageParams) {
            ...
            if (atyq.b(Integer.valueOf(this.a), Integer.valueOf(setDataUsageParams.a)) && atyq.b(this.b, setDataUsageParams.b)) {
                return true;
            }
        }
        return false;
