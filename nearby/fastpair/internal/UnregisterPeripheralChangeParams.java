...
public final class UnregisterPeripheralChangeParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cigu();
    public cifu a;
    public ciga b;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof UnregisterPeripheralChangeParams) {
            ...
            if (arwb.b(this.a, unregisterPeripheralChangeParams.a) && arwb.b(this.b, unregisterPeripheralChangeParams.b)) {
                return true;
            }
        }
        return false;
