...
public final class RegisterPeripheralChangeParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new ckon();
    public cknz a;
    public ckof b;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof RegisterPeripheralChangeParams) {
            ...
            if (atyq.b(this.a, registerPeripheralChangeParams.a) && atyq.b(this.b, registerPeripheralChangeParams.b)) {
                return true;
            }
        }
        return false;
