...
public final class ParcelableFileWithMetaData extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cjcy();
    public byte[] a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ParcelableFileWithMetaData) {
            ...
            if (Arrays.equals(this.a, parcelableFileWithMetaData.a) && arwb.b(this.b, parcelableFileWithMetaData.b)) {
                return true;
            }
        }
        return false;
