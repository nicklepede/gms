...
public final class AdvertisingOptions extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new ciuw();
    public int A;
    public byte[] B;
    public boolean C;
    public int D;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof AdvertisingOptions) {
            ...
            if (arwb.b(this.a, advertisingOptions.a) && arwb.b(Boolean.valueOf(this.b), Boolean.valueOf(advertisingOptions.b)) && arwb.b(Boolean.valueOf(this.c), Boolean.valueOf(advertisingOptions.c)) && arwb.b(Boolean.valueOf(this.d), Boolean.valueOf(advertisingOptions.d)) && arwb.b(Boolean.valueOf(this.e), Boolean.valueOf(advertisingOptions.e)) && Arrays.equals(this.f, advertisingOptions.f) && arwb.b(Boolean.valueOf(this.g), Boolean.valueOf(advertisingOptions.g)) && arwb.b(this.h, advertisingOptions.h) && arwb.b(Boolean.valueOf(this.i), Boolean.valueOf(advertisingOptions.i)) && arwb.b(Boolean.valueOf(this.j), Boolean.valueOf(advertisingOptions.j)) && arwb.b(Boolean.valueOf(this.k), Boolean.valueOf(advertisingOptions.k)) && arwb.b(Boolean.valueOf(this.l), Boolean.valueOf(advertisingOptions.l)) && arwb.b(Boolean.valueOf(this.m), Boolean.valueOf(advertisingOptions.m)) && arwb.b(Boolean.valueOf(this.n), Boolean.valueOf(advertisingOptions.n)) && arwb.b(Integer.valueOf(this.o), Integer.valueOf(advertisingOptions.o)) && arwb.b(Integer.valueOf(this.p), Integer.valueOf(advertisingOptions.p)) && Arrays.equals(this.q, advertisingOptions.q) && arwb.b(Long.valueOf(this.r), Long.valueOf(advertisingOptions.r)) && Arrays.equals(this.s, advertisingOptions.s) && arwb.b(Boolean.valueOf(this.t), Boolean.valueOf(advertisingOptions.t)) && arwb.b(Boolean.valueOf(this.u), Boolean.valueOf(advertisingOptions.u)) && arwb.b(Boolean.valueOf(this.v), Boolean.valueOf(advertisingOptions.v)) && arwb.b(Boolean.valueOf(this.w), Boolean.valueOf(advertisingOptions.w)) && Arrays.equals(this.x, advertisingOptions.x) && Arrays.equals(this.y, advertisingOptions.y) && arwb.b(Boolean.valueOf(this.z), Boolean.valueOf(advertisingOptions.z)) && arwb.b(Integer.valueOf(this.A), Integer.valueOf(advertisingOptions.A)) && Arrays.equals(this.B, advertisingOptions.B) && arwb.b(Boolean.valueOf(this.C), Boolean.valueOf(advertisingOptions.C)) && arwb.b(Integer.valueOf(this.D), Integer.valueOf(advertisingOptions.D)) && arwb.b(Boolean.valueOf(this.E), Boolean.valueOf(advertisingOptions.E)) && arwb.b(Boolean.valueOf(this.F), Boolean.valueOf(advertisingOptions.F)) && arwb.b(Boolean.valueOf(this.G), Boolean.valueOf(advertisingOptions.G)) && arwb.b(Boolean.valueOf(this.H), Boolean.valueOf(advertisingOptions.H)) && arwb.b(Long.valueOf(this.I), Long.valueOf(advertisingOptions.I)) && arwb.b(this.J, advertisingOptions.J) && arwb.b(this.K, advertisingOptions.K)) {
                return true;
            }
        }
        return false;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        arxc.v(parcel, 36, this.J, false);
        arxc.t(parcel, 37, this.K, i, false);
        arxc.c(parcel, a);
    }
