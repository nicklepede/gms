...
public final class StartListeningParamsV3 extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cjdz();
    public cjbp a;
    public String b;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof StartListeningParamsV3) {
            ...
            if (arwb.b(this.a, startListeningParamsV3.a) && arwb.b(this.b, startListeningParamsV3.b) && arwb.b(this.c, startListeningParamsV3.c) && arwb.b(this.d, startListeningParamsV3.d) && arwb.b(this.e, startListeningParamsV3.e) && arwb.b(this.f, startListeningParamsV3.f)) {
                return true;
            }
        }
        return false;
