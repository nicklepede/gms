...
import defpackage.ctzh;
import defpackage.ctzj;
import defpackage.cuac;
import java.util.Arrays;

/* compiled from: :com.google.android.gms@251864004@25.18.64 (040400-758020094) */
/* loaded from: classes6.dex */
public final class UwbAvailabilityObserverParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cuac();
    public ctzj a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof UwbAvailabilityObserverParams) {
            return atyq.b(this.a, ((UwbAvailabilityObserverParams) obj).a);
        }
        return false;
    }
    ...
    public UwbAvailabilityObserverParams(IBinder iBinder) {
        ...
        if (iBinder == null) {
            ...
            ctzhVar = queryLocalInterface instanceof ctzj ? (ctzj) queryLocalInterface : new ctzh(iBinder);
        }
        this.a = ctzhVar;
    }
}
