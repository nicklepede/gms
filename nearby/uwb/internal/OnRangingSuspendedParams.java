...
public final class OnRangingSuspendedParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new crqm();
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof OnRangingSuspendedParams) {
            ...
            if (arwb.b(this.a, onRangingSuspendedParams.a) && arwb.b(Integer.valueOf(this.b), Integer.valueOf(onRangingSuspendedParams.b))) {
                return true;
            }
        }
        return false;
