...
public final class UwbComplexChannelParams extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new crqz();
    public int a;
    public int b;
    public int c;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof UwbComplexChannelParams) {
            ...
            if (arwb.b(Integer.valueOf(this.a), Integer.valueOf(uwbComplexChannelParams.a)) && arwb.b(Integer.valueOf(this.b), Integer.valueOf(uwbComplexChannelParams.b)) && arwb.b(Integer.valueOf(this.c), Integer.valueOf(uwbComplexChannelParams.c))) {
                return true;
            }
        }
        return false;
