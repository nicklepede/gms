...
public final class ContactsConsentsStatus extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cwcl();
    ...
    public final boolean equals(Object obj) {
        ...
        return ekus.a(this.a, contactsConsentsStatus.a) && ekus.a(this.b, contactsConsentsStatus.b) && ekus.a(this.c, contactsConsentsStatus.c);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        int a = atzr.a(parcel);
        atzr.t(parcel, 1, contactsConsentsCoarseStatus, i, false);
