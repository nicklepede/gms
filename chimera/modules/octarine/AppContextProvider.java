package com.google.android.gms.chimera.modules.octarine;
...
public class AppContextProvider extends anye {
    ...
    private static void setApplicationContextV0(Context context) {
        eike.a(c == null);
        c = new AppContextProvider(context, "com.google.android.gms.chimera.modules.octarine.ModuleApplication");
    }
}
