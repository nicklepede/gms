package com.google.android.gms.chimera.modules.backup.settings;
...
public class AppContextProvider extends apzw {
    ...
    private static void setApplicationContextV0(Context context) {
        ekxj.a(c == null);
        c = new AppContextProvider(context, "com.google.android.gms.chimera.modules.backup.settings.ModuleApplication");
    }
}
