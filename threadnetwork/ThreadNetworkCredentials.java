...
public final class ThreadNetworkCredentials extends AbstractSafeParcelable {
    ...
    public static final Parcelable.Creator CREATOR = new dfgf();
    public static final dfgd a = new dfgd(672, new byte[]{-1, -8});
    public static final dfgc b = new dfgc(0, new byte[]{0, 31, -1, -32});
    private static final eits n = eits.t((byte) 0, "Channel", (byte) 1, "PAN ID", (byte) 2, "Extended PAN ID", (byte) 3, "Network Name", (byte) 4, "PSKc", (byte) 5, "Network Key", (byte) 7, "Mesh Local Prefix", (byte) 12, "Security Policy", (byte) 14, "Active Timestamp", (byte) 53, "Channel Mask");
    public static final Charset c = Charset.forName("UTF-8");

    public ThreadNetworkCredentials(byte[] bArr, long j, long j2, boolean z) {
        this.g = dfge.c(f((byte) 14, bArr));
        ...
        arwm.d(true, "Invalid Thread Channel Page (page = %d, allowedRange = [0, 255])", valueOf);
        int i4 = i3 | (i2 << 8);
        if (i != 0) {
            Integer valueOf2 = Integer.valueOf(i4);
            arwm.d(true, "Invalid Thread Channel %d in page %d (channel = %d, allowedRange = [0, 65535])", valueOf2, valueOf, valueOf2);
        } else {
            arwm.d(i4 >= 11 && i4 <= 26, "Invalid Thread Channel %d in page %d (allowedChannelRange = [%d, %d])", Integer.valueOf(i4), valueOf, 11, 26);
        }
        this.j = new int[]{i4, i}[0];
        this.i = i;
        this.k = dfgb.b(f((byte) 53, bArr));
        this.l = dfgb.a(f((byte) 1, bArr));
        ...
        this.m = new dfgd(((f3[0] & 255) << 8) | (f3[1] & 255), Arrays.copyOfRange(f3, 2, f3.length));
    ...
    */
    ...
    public final String toString() {
        return String.format(Locale.US, "{ExtendedPanId: %s, ActiveTimestamp: %s}", ejtk.f.n(this.p), this.g);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        arxc.q(parcel, 2, this.d);
        arxc.q(parcel, 3, this.e);
        arxc.e(parcel, 4, this.f);
        arxc.c(parcel, a2);
    }
}
