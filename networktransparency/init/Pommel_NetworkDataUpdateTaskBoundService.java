...
public abstract class Pommel_NetworkDataUpdateTaskBoundService extends GmsTaskBoundService implements cyvn, cyyi {
    ...
    public final void onCreate() {
        if (!this.c) {
            this.c = true;
            ((cubu) h()).a((NetworkDataUpdateTaskBoundService) this);
        }
        super.onCreate();
    }
}
