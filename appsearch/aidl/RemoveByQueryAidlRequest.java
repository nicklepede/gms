...
public class RemoveByQueryAidlRequest extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new wbr();
    ...
    public RemoveByQueryAidlRequest(AppSearchAttributionSource appSearchAttributionSource, String str, String str2, SearchSpec searchSpec, UserHandle userHandle, long j) {
