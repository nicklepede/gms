    ...
    */
    public final void onHandleIntent(android.content.Intent r17) {
        ...
        L1e:
            ...
            java.lang.String r0 = defpackage.dgxk.b(r3)     // Catch: java.lang.Throwable -> L42
            int r0 = r5.getInt(r0, r4)     // Catch: java.lang.Throwable -> L42
            monitor-exit(r5)     // Catch: java.lang.Throwable -> L42
            r6 = r16
            java.util.List r0 = defpackage.uoh.j(r6, r0, r3)     // Catch: java.lang.Throwable -> L4b
            goto L59
        L42:
            r0 = move-exception
            r6 = r16
        ...
        L49:
            r6 = r16
        L4b:
            asot r0 = defpackage.dgxg.a
            ejgq r0 = r0.i()
            java.lang.String r5 = "Error getting account change events."
            r7 = 11800(0x2e18, float:1.6535E-41)
        ...
        L59:
            ...
            java.lang.String r9 = defpackage.dgxk.b(r3)     // Catch: java.lang.Throwable -> Lcf
            ...
            int[] r9 = defpackage.dgxk.a     // Catch: java.lang.Throwable -> Lcc
        L90:
            r10 = 2
            if (r4 >= r10) goto Lc2
            r10 = r9[r4]     // Catch: java.lang.Throwable -> Lcc
            java.lang.String r11 = defpackage.dgxk.c(r3, r10)     // Catch: java.lang.Throwable -> Lcc
            java.lang.String r12 = defpackage.dgxk.d(r3, r10)     // Catch: java.lang.Throwable -> Lcc
            boolean r13 = r7.getBoolean(r11, r5)     // Catch: java.lang.Throwable -> Lcc
            r14 = 0
            long r14 = r7.getLong(r12, r14)     // Catch: java.lang.Throwable -> Lcc
            r17 = r1
            java.lang.String r1 = defpackage.dgxk.c(r0, r10)     // Catch: java.lang.Throwable -> Lcc
            r8.putBoolean(r1, r13)     // Catch: java.lang.Throwable -> Lcc
            r8.remove(r11)     // Catch: java.lang.Throwable -> Lcc
            java.lang.String r1 = defpackage.dgxk.d(r0, r10)     // Catch: java.lang.Throwable -> Lcc
