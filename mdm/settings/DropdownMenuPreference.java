...
public class DropdownMenuPreference extends Preference {
    ...
    public final void a(kmp kmpVar) {
        super.a(kmpVar);
        MaterialAutoCompleteTextView materialAutoCompleteTextView = (MaterialAutoCompleteTextView) kmpVar.a.findViewById(R.id.status_auto_complete);
        if (materialAutoCompleteTextView != null) {
            ...
            materialAutoCompleteTextView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: ccuz
                ...
                public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                    ...
                    ccxv ccxvVar = dropdownMenuPreference.b;
                    if (ccxvVar != null) {
                        ccxvVar.a.K();
                    }
                }
