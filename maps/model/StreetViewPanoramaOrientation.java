...
public class StreetViewPanoramaOrientation extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new cceq();
    ...
    public StreetViewPanoramaOrientation(float f, float f2) {
        ...
        arwm.c(z, "Tilt needs to be between -90 and 90 inclusive: " + f);
        this.a = f + 0.0f;
    ...
    public final String toString() {
        ...
        arwa.b("tilt", Float.valueOf(this.a), arrayList);
        arwa.b("bearing", Float.valueOf(this.b), arrayList);
